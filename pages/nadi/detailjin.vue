		...
		<div class="container">
			<div class="dazong_detail_main">
				<div class="left">
					...
					<div class="content">
						<h5>基础信息</h5>
						<p class="cs_p">拿地方式 ：<span>{{ ownerDetailed.way }}</span></p>
						<p class="cs_p">所在区域 ：<span>{{ ownerDetailed.province }}  {{ ownerDetailed.city }}</span></p>
				...
				<div class="right">
					...
					<div class="img_list" v-for="(item,index) in keyProjects.list" :key="index">
						<nuxt-link :to="{path:'/nadi/detailjin',query:{id:item.id,nav:'1'}}">
