			...
			<div class="dazong_detail_main">
				<div class="left">
					<div class="tit pointer">
						<nuxt-link to='/nadi'>
							<span class="choose">供土地</span>
						</nuxt-link>
						<nuxt-link to='/nadi?id=2'>
							<span>求土地</span>
						</nuxt-link>
					</div>
					<div class="content">
					...
					<div class="content">
						<h5>基础信息</h5>
						<p class="cs_p">拿地方式 ：<span>{{ tradingDetailed.land }}</span></p>
				...
				<div class="right">
					...
					<div class="img_list" v-for="(item,index) in keyProjects.list" :key="index">
						<nuxt-link :to="{path:'/nadi/detail',query:{id:item.id,nav:'2'}}">
